...
daniel = User.create!(nom: "Daniel", prenom: "Peterson", email: "daniel@peterson.com", password: "123456", isAdmin: 0)
robert = User.create!(nom: "Robert", prenom: "Skywalker", email: "robert@skywalker.com", password: "123456", isAdmin: 0)
admin = User.create!(nom: "Admin", prenom: "Admin", email: "the@admin.com", password: "123456", isAdmin: 1)
